...
class RelativesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relative" do
    assert_difference('Relative.count') do
      post relatives_url, params: { relative: { address: @relative.address, contact_number: @relative.contact_number, name: @relative.name, relation: @relative.relation, user_id: @relative.user_id } }
    end
  ...
  test "should update relative" do
    patch relative_url(@relative), params: { relative: { address: @relative.address, contact_number: @relative.contact_number, name: @relative.name, relation: @relative.relation, user_id: @relative.user_id } }
