class EducationCredentialsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @education_credential.save
        format.html { redirect_to @education_credential, notice: 'Education credential was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @education_credential.update(education_credential_params)
        format.html { redirect_to @education_credential, notice: 'Education credential was successfully updated.' }
